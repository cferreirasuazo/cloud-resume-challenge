...
export const ResumeCard = ({
  ...
  return (
    <Link href={href || "#"} className="block cursor-pointer" onClick={handleClick}>
      <Card className="flex border-none bg-transparent p-0 shadow-none transition-all duration-300 hover:opacity-100 dark:hover:opacity-100">
        <div className="flex-none">
          <Avatar className="size-12 m-auto border bg-muted-background dark:bg-foreground">
        ...
        <div className="group ml-4 flex-grow flex-col items-center">
          <CardHeader className="p-0">
            <div className="flex items-center justify-between gap-x-2 text-base">
              ...
              <div className="text-right text-xs text-muted-foreground sm:text-sm">{period}</div>
            </div>
